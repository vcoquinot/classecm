...
<head>
    ...
    <title>Soustraction par 1000</title>
</head>
...
<body>
    ...
    $numberThousand = 1000; ?>
    <div class="container">
            <h1 class="text-center">Soustraction par 1000</h1>
            <header class="quizz text-center mb-4 pt-2 pb-2 bg-info">
                ...
                <!-- Image -->
                <img src='https://avataaars.io/?avatarStyle=Circle&topType=LongHairBun&accessoriesType=Round&hairColor=Black&facialHairType=Blank&clotheType=ShirtCrewNeck&clotheColor=Heather&eyeType=Default&eyebrowType=DefaultNatural&mouthType=Smile&skinColor=DarkBrown' alt=""/>
            </header>
        <!-- operation form-->
            <main>
                    ...
                    <div class="col-12">
                        <div class="row justify-content-center"> 
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center">
                                ...
                                value="<?php echo $firstCorrectResult= substract($randFirstNumber, $numberThousand); 
                                ?>">
                            </div>                    
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center">
                                <!-- first random number-->
                                ...
                                value="<?php echo $secondCorrectResult= substract($randFirstNumber, $numberThousand); 
                                ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-12 mt-4">
                        <div class="row justify-content-center"> 
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center">
                                ...
                                value="<?php echo $thirdCorrectResult= substract($randFirstNumber, $numberThousand); 
                                ?>">
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center">
                                ...
                                value="<?php echo $fourthCorrectResult= substract($randFirstNumber, $numberThousand); 
                                ?>">
                            </div>
                        </div>
                        <!--validation button-->
