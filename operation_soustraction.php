...
<html lang="fr">
   <head>
      ...
      <title>soustractions posées</title>
   </head>
   <body>
   <?php     
    // Affectation + two random numbers to substract    
    $a=0;
    $b=0;
    $randFirstNumber = mt_rand(100,999);
    $randSecondNumber = mt_rand(10,99);
    if ($randFirstNumber < $randSecondNumber){
        //TO DO first number biiger than second number
    }
    ?>

    <div class="container">
        <h1 class="text-center">Soustractions posées</h1>
          ...
          <!-- operation display-->
            ...
            <div>
              <!-- hidden input to send user answer data-->
                <input type="hidden" name="correctTotal" value="<?php $correctTotal= substract($randFirstNumber, $randSecondNumber); 
                echo $correctTotal; ?>">
                <input type="hidden" name="questionNumber">
                <input class="input" type="hidden" name="url" value="operation_soustraction.php">
            </div>
            <!-- validation button-->
            <div class="row justify-content-center">
