...
<!DOCTYPE html>
    ...
    <body> 
        <div class="container">
            ...
            <!-- Image -->
            <img src='https://avataaars.io/?avatarStyle=Circle&topType=LongHairStraightStrand&accessoriesType=Round&hairColor=Blonde&facialHairType=Blank&clotheType=ShirtVNeck&clotheColor=Blue02&eyeType=Default&eyebrowType=Default&mouthType=Default&skinColor=Pale' alt="">

            <?php
            //BDD random question
            $question = $bdd->query("SELECT intitule_question, id_question FROM question WHERE id_matiere = 2 && id_theme = 16 ORDER BY RAND() LIMIT 1");
            ...
            <div class="form-group">
                <form action="cible_conjugaison.php" method="get">        
                    ...
                    <!--Form answer-->
                    <?php conjugationForm();?>
                    <input class="input border border-primary" type="hidden" name="url" value="conjugaison_imparfait_groupe1.php">
                </form>
            </div>
        </main>
    </body>
