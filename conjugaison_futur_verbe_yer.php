...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>conjugaison : futur des verbes finissant par -yer</title>
    </head>

    <body> 
        <div class="container">
            <header class="d-flex align-items-center flex-column">
                <h1>conjugaison : futur des verbes finissant par -yer</h1>
            </header>
            ...
            <div class="form-group">
                <form action="cible_conjugaison.php" method="get">        
                    ...
                    <!--Form answer-->
                    <?php conjugationForm();?>
                    <input class="input border border-primary" type="hidden" name="url" value="conjugaison_futur_verbe_yer.php">
                </form>
            </div>
        </main>
    </body>
