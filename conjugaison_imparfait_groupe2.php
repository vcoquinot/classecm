...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>conjugaison : imparfait des verbes du deuxième groupe</title>
    </head>

    <body> 
        <div class="container">
            <header class="d-flex align-items-center flex-column">
                <h1>conjugaison : imparfait des verbes du deuxième groupe</h1>
            </header>
            ...
            <?php
            //BDD random question
            $question = $bdd->query("SELECT intitule_question, id_question FROM question WHERE id_matiere = 2 && id_theme = 18 ORDER BY RAND() LIMIT 1");
            ...
            <div class="form-group">
                <form action="cible_conjugaison.php" method="get">        
                    ...
                    <!--Form answer-->
                    <?php conjugationForm();?>
                    <input class="input border border-primary" type="hidden" name="url" value="conjugaison_imparfait_groupe2.php">
                </form>
            </div>
        </main>
    </body>
