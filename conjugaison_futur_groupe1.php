...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>conjugaison : futur des verbes en -ER et -IR</title>
    </head>

    <body> 
        <div class="container">
            <header class="d-flex align-items-center flex-column">
                <h1>conjugaison : futur des verbes en -ER et -IR</h1>
            </header>
            ...
            <div class="form-group">
                <form action="cible_conjugaison.php" method="get">        
                    ...
                    <!--Form answer-->
                    <?php conjugationForm();?>
                    <input class="input border border-primary" type="hidden" name="url" value="conjugaison_futur_groupe1.php">
                </form>
            </div>
        </main>
    </body>
