...
<body>
    ...
    $numberTen = 10;?>
    <div class="container">
            <h1 class="text-center">Addition par 10</h1>
            <header class="quizz text-center mb-4 pt-2 pb-2 bg-info">
                ...
                <!-- Image -->
                <img src='https://avataaars.io/?avatarStyle=Circle&topType=ShortHairShortRound&accessoriesType=Round&hairColor=Blonde&facialHairType=Blank&clotheType=ShirtVNeck&clotheColor=Black&eyeType=Default&eyebrowType=DefaultNatural&mouthType=Smile&skinColor=Pale' alt=""/>
            </header>
        <!-- operation form-->
            <main>
                    ...
                    <div class="col-12">
                        <div class="row justify-content-center"> 
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center">
                                ...
                                value="<?php echo $firstCorrectResult= add($randFirstNumber, $numberTen); 
                                ?>">
                            </div>                    
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center">
                                <!-- first random number-->
                                ...
                                value="<?php echo $secondCorrectResult= add($randFirstNumber, $numberTen); 
                                ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-12 mt-4">
                        <div class="row justify-content-center"> 
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center">
                                ...
                                value="<?php echo $thirdCorrectResult= add($randFirstNumber, $numberTen); 
                                ?>">
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center">
                                ...
                                value="<?php echo $fourthCorrectResult= add($randFirstNumber, $numberTen); 
                                ?>">
                            </div>
                        </div>
                        <!--validation button-->
