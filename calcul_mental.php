                ...
                <article class="col-lg-6">
                    ...
                    <a data-toggle="collapse" href="#collapse_add" role="button" aria-expanded="false"
                        ...
                        <div class="collapse" id="collapse_add">
                            ...
                            <button class="list-group-item btn btn-primary mb-2" href="addition_mentale_unites.php">Unités</button>
                            <button class="list-group-item btn btn-primary mb-2" href="addition_mentale_10.php">+10</button>
                            <button class="list-group-item btn btn-primary mb-2" href="addition_mentale_100.php" >+100</button>
                            <button class="list-group-item btn btn-primary mb-2" href="addition_mentale_1000.php">+1000</button>
                            </div>
                        </div>
                    </div>
                </article>
